...
import { AlphaNumericFieldValidator, NoWhiteSpaceFieldValidator } from 'src/app/shared/validations/validation.validator';
...
export class SizeComponent {
  ...
  setFormData(){
    ...
    this.fData = this._fb.group({
      id:[0],
      name:['',Validators.compose([Validators.required,Validators.minLength(2),Validators.maxLength(12),AlphaNumericFieldValidator.ValidAlphaNumericField,NoWhiteSpaceFieldValidator.ValidNoWhiteSpaceField])]
    })
  }
  ...
  getAllRecords(){
    ...
    this._httpService.get(Global.BASE_API_URL+'SizeMaster/GetAll').subscribe(res=>{
      console.log('SizeMaster -> GetAll: ',res);
      if(res.isSuccess){
    ...
    switch(this.dbOperations){
      case DbOperations.create:
        ...
        this._httpService.post(Global.BASE_API_URL+'SizeMaster/Save/',this.fData.value).subscribe(res=>{
          console.log('SizeMaster -> Save: ',res);
          if(res.isSuccess){
      ...
      case DbOperations.update:
        ...
        this._httpService.post(Global.BASE_API_URL+'SizeMaster/Update/',this.fData.value).subscribe(res=>{
          console.log('SizeMaster -> Update: ',res);
          if(res.isSuccess){
    ...
    swalWithBootstrapButtons.fire({
      ...
      if (result.isConfirmed) {
        ...
        this._httpService.post(Global.BASE_API_URL+'SizeMaster/Delete/',{"id":id}).subscribe(res=>{
          console.log('SizeMaster -> Delete: ',res);
          console.log(res);
          if(res.isSuccess){
            swalWithBootstrapButtons.fire({
              title: "Deleted!",
